...
export function ChatInterface({ onToggleTheme, isDarkMode }: ChatInterfaceProps) {
  ...
  return (
    <div className="flex flex-col h-screen relative overflow-hidden">
      {/* Modern glassmorphic background with subtle gradient */}
      <div 
        className="absolute inset-0 bg-gradient-to-br from-slate-50/90 via-white/95 to-blue-50/80 dark:from-slate-900/90 dark:via-gray-900/95 dark:to-blue-900/80"
        style={{
      ...
      <Sheet open={isChatHistoryOpen} onOpenChange={setIsChatHistoryOpen}>
        <SheetContent side="left" className="w-80 p-0 bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-r border-white/20 dark:border-gray-800/40">
