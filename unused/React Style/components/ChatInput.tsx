...
export function ChatInput({ 
  ...
  const handleCommandSelect = (command: any) => {
    ...
    switch (cmd) {
      case '/tools':
        setShowSageTools(true);
        break;
      case '/tasks':
        onToolSelect?.('tasks');
        break;
      case '/analytics':
        onToolSelect?.('analytics');
        break;
      case '/radar':
        onToolSelect?.('radar');
        break;
      case '/help':
        onSendMessage('Help: Available commands are /tools, /tasks, /analytics, /radar, and more. Type / to see all options.');
        break;
      default:
    ...
    <div className="bg-white/60 dark:bg-gray-900/60 backdrop-blur-xl border-t border-white/20 dark:border-gray-800/40 shadow-lg shadow-black/5 dark:shadow-black/20">
      ...
      >
            ...
            <div className="flex-1">
              {isExpanded ? (
                <div className="relative">
                  <textarea
                    ...
                    className="
                      ...
                      placeholder:text-gray-500 dark:placeholder:text-gray-400 text-black dark:text-white caret-blue-500 dark:caret-white
                ...
                <textarea
                  ...
                  disabled={disabled}
                  className="
                    w-full bg-white/30 dark:bg-gray-800/30 border border-gray-200/40 dark:border-gray-700/40 rounded-lg px-3 py-2
                    outline-none resize-none transition-all duration-300 backdrop-blur-sm
                    placeholder:text-gray-500 dark:placeholder:text-gray-400 text-black dark:text-white caret-blue-500 dark:caret-white
                    scrollbar-thin scrollbar-thumb-border scrollbar-track-transparent
                    focus:border-blue-400/50 dark:focus:border-blue-600/50 focus:bg-white/50 dark:focus:bg-gray-800/50
                  "
                  rows={1}
                  style={{
                    height: 'auto',
        ...
        <TerminalCommandPalette
          isOpen={showCommandPalette && message.length > 0}
