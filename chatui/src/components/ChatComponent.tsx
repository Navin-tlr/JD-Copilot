...
export default function ChatComponent() {
  ...
  return (
    <div className="w-full max-w-[312px] h-[85px] rounded-[5px] bg-chat-bg shadow-lg mx-auto border border-white/25">
      ...
      <button className="p-1 hover:bg-white/10 rounded transition-colors">
        ...
        stroke="#A9A9A9" 
          ...
          <button onClick={handleSend} className="p-1 hover:bg-white/10 rounded transition-colors">
            <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M6 4L9 7L6 10" stroke="#B5B5B5" strokeOpacity="0.95" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M7 13.5C10.5899 13.5 13.5 10.5899 13.5 7C13.5 3.41015 10.5899 0.5 7 0.5C3.41015 0.5 0.5 3.41015 0.5 7C0.5 10.5899 3.41015 13.5 7 13.5Z" stroke="#B5B5B5" strokeOpacity="0.95" strokeLinecap="round" strokeLinejoin="round" />
            </svg>
          </button>
        </div>
      </div>
